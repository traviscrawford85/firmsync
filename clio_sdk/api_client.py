...
from clio_sdk.api_response import ApiResponse, T as ApiResponseT
import clio_sdk.models as clio_sdk_models
from clio_sdk import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(clio_sdk_models, klass)
