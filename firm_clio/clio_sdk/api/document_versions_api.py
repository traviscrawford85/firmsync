...
class DocumentVersionsApi:
    ...
    @validate_call
    def document_version_index(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentVersion.")],
        id2: Annotated[StrictInt, Field(description="ID of the Document")],
        ...
        fully_uploaded: Annotated[Optional[StrictBool], Field(description="Filter DocumentVersion records to those with the given `fully_uploaded` status.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of DocumentVersion records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        ...
        _param = self._document_version_index_serialize(
            id=id,
            id2=id2,
    ...
    def document_version_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DocumentVersionList]:
        """Return the data for all DocumentVersions
    ...
    @validate_call
    def document_version_index_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier for the DocumentVersion.")],
        id2: Annotated[StrictInt, Field(description="ID of the Document")],
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
    ...
    def _document_version_index_serialize(
        self,
        id,
        id2,
        x_api_version,
        ...
        if fully_uploaded is not None:
            
            _query_params.append(('fully_uploaded', fully_uploaded))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/{id}/versions.json',
